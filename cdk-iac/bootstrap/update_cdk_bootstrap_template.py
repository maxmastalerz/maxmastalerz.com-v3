...
with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "bootstrap-template-orig.yaml"), 'rb') as stream:
    try:
        ...
        with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "bootstrap-template.yaml"), "w", encoding='utf8') as f:
